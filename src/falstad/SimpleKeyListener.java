...
/**
 * Class implements a translation for the user input handled by the
 * MazeController class. The MazeApplication attaches the listener to the GUI,
 * such that user keyboard input flows from GUI to the listener.keyPressed to
...
public class SimpleKeyListener implements KeyListener {
	...
	/**
	 * Translate keyboard input to the corresponding operation for the
	 * MazeController.keyDown method.
	 */
	@Override
	public void keyPressed(KeyEvent arg0) {
		...
		case ('w' & 0x1f): // Ctrl-w makes a step forward even through a wall
			...
			break;
		case '\t':
		case 'm': // show local information: current position and visible walls
		...
		case KeyEvent.CHAR_UNDEFINED: // fall back if key is undefined but code is
			...
			} else { // THIS IS THE PORTION I CAN DIVERT FOR MANUALDRIVER
	...
	public void keyTyped(KeyEvent arg0) {
		// NOTE FOR THIS TYPE OF EVENT IS getKeyCode always 0, so Escape etc is not
		// recognized
