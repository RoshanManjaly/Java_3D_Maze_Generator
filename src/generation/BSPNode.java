 ...
 * segments. A BSP tree is a data structure to search for a set of segments to
 * put on display in the FirstPersonDrawer.
 * 
...
public class BSPNode {
	/*
	 * lower and upper bounds for (x,y) coordinates of segments carried in leaf
	 * nodes.
	 */
	private int xl;
	private int yl;
	 ...
	 * 
	 * @param x
	 *            used to update xl and xu
	 * @param y
	 *            used to update yl and yu
	 */
