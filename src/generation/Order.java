...
/**
 * An order describes functionality needed to order a maze from the maze
 * factory. It allows for asynchronous production with a mechanism to deliver a
 * MazeConfiguration.
 * 
 * @author pk
 *
...
public interface Order {
	...
	/**
	 * Lists all maze generation algorithms that are supported by the maze factory
	 * (Eller needs to be implemented for P2)
	 * 
	 * @author pk
	 *
	 */
	enum Builder {
		DFS, Prim, Kruskal, Eller
	};
