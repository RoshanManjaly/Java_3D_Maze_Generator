...
/**
 * Basic class to describe a wall which is located at a cell (x,y) and at that
 * cell it is located in a particular direction. One can compute the location of
 * a neighboring cell, however that location is only valid for internal wall,
 * i.e. if the neighboring cell is inside the maze.
 * 
 * It is used to hold wall coordinates for Prims Maze Generation and for the
 * logging mechanism.
 */
public class Wall {
	 ...
	 * 
	 * @param x
	 *            is the x coordinate, 0 <= x < width
	 * @param y
	 *            is the y coordinate, 0 <= y < height
	 * @param cd
	 *            is the direction of wall in the cell
	 */
	...
	/**
	 * Sets the internal fields to the given values for a (x,y) position and
	 * direction
	 * 
	 * @param x
	 *            is the x coordinate, 0 <= x < width
	...
	/**
	 * Pick a random position (x,y) and a random direction within the given limits
	 * and assign these values to this wall.
	 * 
	 * @param width
	 *            such that 0 <= x < width
	 * @param height
	 *            such that 0 <= y < height
	 */
	 ...
	 * If the wall is a border wall to the outside, then the resulting value is out
	 * of range as the cell does not exist.
	 * 
	...
	/**
	 * Provides the direction for the wall with regard to the internal position
	 * (x,y).
	 * 
